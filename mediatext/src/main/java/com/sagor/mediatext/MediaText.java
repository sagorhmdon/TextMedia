...
public class MediaText extends WebView {
    ...
    public MediaText(Context context) {
        this(context, null);
    }

    public MediaText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.webViewStyle);
    }

    @SuppressLint("SetJavaScriptEnabled")
    public MediaText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setFontSize(int fontSize) {
        if (fontSize > 7 || fontSize < 1) {
            Log.e("MediaText", "Font size should have a value between 1-7");
        }
    ...
    public void insertVideos(String url, String alt) {
        exec("javascript:RE.prepareInsert();");
        exec("javascript:RE.insertVideos('" + url + "', '" + alt + "');");
    }

    public void insertFiles(String name) {
        exec("javascript:RE.prepareInsert();");
        exec("javascript:RE.insertImage('" + name + "');");
    }
